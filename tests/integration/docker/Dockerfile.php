...
# Extensions required by Joomla 5/6. gd must have WebP support: the plugin's
# local thumbnail cache writes WebP and silently turns itself off without it
# (Preview::canResizeImages()).
